...
export class GoogleMetricService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/google-metrics';
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IGoogleMetric[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
